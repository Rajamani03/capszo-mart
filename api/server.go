...
func (server *Server) SetupRouter() {
	...
	customerRouter.PUT("/customer", server.updateCustomerInfo)
	customerRouter.GET("/item/:id", server.getItem)
	customerRouter.GET("/mart-items", server.getMartItems)
	customerRouter.GET("/items", server.searchItem)
	customerRouter.GET("/mart/:id/order-preferences", server.getMartOrderPreference)
